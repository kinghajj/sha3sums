/* FILE: essence_compress_256_64_const_time
 *
 ...
 * and that arithmetic shift right C operations will result in the
 * sign bit being copied (as described in the implementation notes
					...
					uint64_t num_steps)
{
  ...
  while(input_size_in_256_bit_blocks > 0)
      ...
      for(i=0;i<num_steps;i++)
	{
	  ...
	  for(j=0;j<32;j++)
	    {
	      r0 = (((int32_t)r0 >> 31) & P_32) ^ (r0 << 1);
	      k0 = (((int32_t)k0 >> 31) & P_32) ^ (k0 << 1);
	    }
