...
/*
 * void essence_compress_512_64(uint64_t *Chaining_Variables,
 *                              BitSequence *input,
 ...
 *
 */
void essence_compress_512_64(uint64_t *,
			     BitSequence *,
			     uint64_t,
			     uint64_t);
...
/*
 * void essence_compress_512_64_const_time(uint64_t *Chaining_Variables,
 *                                         BitSequence *input,
 *                                         uint64_t input_size_in_512_bit_blocks,
 *			                   uint64_t num_steps)
 *
 ...
 *
 */
void essence_compress_512_64_const_time(uint64_t *,
			                BitSequence *,
			                uint64_t,
			                uint64_t);
 ...
 *
 */
void essence_compress_512_const_time(uint64_t *,
			             BitSequence *,
			             uint64_t,
			             uint64_t);
...
/*
 * void essence_compress_256_64_dual(uint32_t *Chaining_Variables_a,
 *                                   uint32_t *Chaining_Variables_b,
 *                                   BitSequence *input_a,
 *                                   BitSequence *input_b
 ...
 *
 */
void essence_compress_256_64_dual(uint32_t *,
			          uint32_t *,
			          BitSequence *,
			          BitSequence *,
			          uint64_t,
...
/*
 * void essence_compress_256_64_dual_const_time(uint32_t *Chaining_Variables_a,
 *                                              uint32_t *Chaining_Variables_b,
 *                                              BitSequence *input_a,
 *                                              BitSequence *input_b
 *                                              uint64_t input_size_in_256_bit_blocks,
 ...
 *
 */
void essence_compress_256_64_dual_const_time(uint32_t *,
			                     uint32_t *,
			                     BitSequence *,
			                     BitSequence *,
			                     uint64_t,
 ...
 *
 */
void essence_compress_256_64(uint32_t *,
			     BitSequence *,
			     uint64_t,
			     uint64_t);
...
/*
 * void essence_compress_256_64_const_time(uint32_t *Chaining_Variables,
 *                                         BitSequence *input,
 *                                         uint64_t input_size_in_256_bit_blocks,
 *			                   uint64_t num_steps)
 *
 ...
 *
 */
void essence_compress_256_64_const_time(uint32_t *,
			                BitSequence *,
			                uint64_t,
			                uint64_t);
 ...
 *
 */
void essence_compress_256_const_time(uint32_t *,
				     BitSequence *,
				     uint64_t,
				     uint64_t);
